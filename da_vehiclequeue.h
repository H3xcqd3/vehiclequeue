...
private:
	...
	void Spawn_Vehicle_DropOff(int Team,DAVehicleQueueStruct *Q);
	void Clear(int Team);
...
private:
	...
	// Secondary drop-off point settings
	Vector3 SecondaryDropPoint[2];  // [0] = GDI, [1] = Nod
	int     QueueThreshold;         // Queue size that triggers secondary drop
};
